...
//
//	mockgen -destination=./internal/client/cmd/auth_service_mock_test.go -package=cmd -mock_names Service=MockAuthService github.com/kuvalkin/gophkeeper/internal/client/service/auth Service
//
