...
//go:generate mockgen -destination=./entry_client_mock.go -package=mocks github.com/kuvalkin/gophkeeper/pkg/proto/entry/v1 EntryServiceClient
...
//go:generate mockgen -destination=./auth_client_mock.go -package=mocks github.com/kuvalkin/gophkeeper/pkg/proto/auth/v1 AuthServiceClient
