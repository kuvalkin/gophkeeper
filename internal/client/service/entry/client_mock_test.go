...
//
//	mockgen -destination=./internal/client/service/entry/client_mock_test.go -package=entry_test github.com/kuvalkin/gophkeeper/internal/proto/entry/v1 EntryServiceClient
//
