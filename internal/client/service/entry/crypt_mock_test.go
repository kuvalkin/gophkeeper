...
//
//	mockgen -destination=./internal/client/service/entry/crypt_mock_test.go -package=entry_test github.com/kuvalkin/gophkeeper/internal/client/service/entry Crypt
//
